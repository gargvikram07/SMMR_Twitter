...
MeruResult = score.sentiment(MeruTweetsCleaned, pos.words , neg.words)
OlaResult = score.sentiment(OlaTweetsCleaned, pos.words , neg.words)
TaxiForSureResult = score.sentiment(TaxiForSureTweetsCleaned, pos.words , neg.words)
UberResult = score.sentiment(UberTweetsCleaned, pos.words , neg.words)
